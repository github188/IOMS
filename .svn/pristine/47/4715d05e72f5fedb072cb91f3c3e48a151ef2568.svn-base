...
<body style="overflow-x:hidden">
	<form:form modelAttribute="pageModel" id="publishNews" name="publishNews" action="#" method="post">
		<form:hidden path="id" />
				...
				<table width="100%">
					...
					<tr>
						...
						<td colspan="5"><input type=radio name="pass"
							value="true" checked="checked">是</input></td>
					</tr>
					<tr>
						<th><font color="red">*</font>备注信息：</th>
						<td colspan="5"><textarea style="width:100%;height:30px" name="remark" id='remark'></textarea></td>
					</tr>
					<tr style="height: 60px" align="center">
						<th colspan="6" align="center" valign="middle">
							...
							<span class="btn">
								<a href="#none" class="reset" onclick="publishNews.reset();">重置</a>
							</span>
						</th>
					</tr>
				</table>
	...
	<script type="text/javascript">
        ...
        $(function() {
        	...
        	$("#submit").click(function() {
                $("#publishNews").attr("action", "${rootUrl }news/publish.do");
                $("#publishNews").trigger("submit");
            });
        });
    </script>
