					...
					<div class="bl">
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									<sec:authorize
										ifAnyGranted="${jspAuthorities['kuservicemng_add']}">
										<a href="${rootUrl }basedata/ku/service/add.do"
											class="my_add{boxwidth:800,boxheight:590} btn"><img
											src="${rootUrl}images/btn/new.gif" />添加</a>
									</sec:authorize>
									<sec:authorize
										ifAnyGranted="${jspAuthorities['kuservicemng_impexcel']}">
										<a href="${rootUrl }basedata/ku/service/impexcel.do"
											class="my_view {boxwidth:900,boxheight:650} btn"><img
											src="${rootUrl}images/btn/file.gif" />Excel导入 </a>
									</sec:authorize>
									<sec:authorize
										ifAnyGranted="${jspAuthorities['kuservicemng_expexcel']}">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}basedata/ku/service/manage.do" method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
											电路名：
											...
											发端子网类型：
											<form:select path="subnetTypeTx" cssStyle="width:135px">
												<form:option value="">-请选择-</form:option>
												<form:options items="${subnetTypes}" itemLabel="value" />
											</form:select>
											收端子网类型：
											<form:select path="subnetTypeRx" cssStyle="width:135px">
												<form:option value="">-请选择-</form:option>
												<form:options items="${subnetTypes}" itemLabel="value" />
											</form:select>
											发端节点号：
											...
											使用情况：
											<form:input path="usageLike" size="10" maxlength="50" />
											收端信息：
