 ...
 * @version:1.0
 */
public interface IKuSatelliteWorkflowService {
	 ...
	 * 
	 */
	public abstract ProcessInstance startWorkflow(KuSatellite entity,
	 ...
	 * 
	 */
	public abstract List<KuSatellite> findTodoTasks(String userId);
	 ...
	 * 
	 */
	public abstract List<KuSatellite> findRunningProcessInstaces();
	 ...
	 * 
	 */
	public abstract List<KuSatellite> findRunningProcessInstaces(String userId);
	 ...
	 * 
	 */
	public abstract List<KuSatellite> findFinishedProcessInstaces();
	 ...
	 * 
	 */
	public abstract List<KuSatellite> findFinishedProcessInstaces(String userId);
