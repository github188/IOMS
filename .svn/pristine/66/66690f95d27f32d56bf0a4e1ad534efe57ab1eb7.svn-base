...
import cn.com.atnc.ioms.entity.operstat.atm.PnniLnsAxsmXG;
 ...
 */
@Service
public class PnniLnsAxsmXGDaoImpl extends MyBaseDao<PnniLnsAxsmXG> implements IPnniLnsAxsmXGDao {
	 ...
	 */
	@Override
	public Pagination queryPnniLnsAxsmXGPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PnniLnsAxsmXG where 1=1 ");
