				...
				.click(
						function() {
							if ($(".pager").attr('totalcount') == '0') {
								...
								window.location.href = "${rootUrl}basedata/tes/node/expexcel.do";
							}
						});
	});
</script>
					...
					<div class="bl">
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									<sec:authorize
										ifAnyGranted="${jspAuthorities['tesnodemng_add']}">
										<a href="${rootUrl }basedata/tes/node/add.do"
											class="my_add{boxwidth:550,boxheight:300} btn"><img
											src="${rootUrl}images/btn/new.gif" />添加</a>
									</sec:authorize>
									<sec:authorize
										ifAnyGranted="${jspAuthorities['tesnodemng_impexcel']}">
										<a href="${rootUrl}basedata/tes/node/impexcel.do"
									...
									<%-- 				<sec:authorize
										ifAnyGranted="${jspAuthorities['tesnodemng_expexcel']}">
										<a href="${rootUrl }basedata/tes/node/expexcel.do" class="btn"><img
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}basedata/tes/node/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
											...
											备注：
											<form:input path="tesNodeInfoLike" size="10" maxlength="50" />
											<%-- 	节点类型：
											<form:select path="equipType">
												<form:option value="">-请选择-</form:option>
												<form:option value="II">II</form:option>
												<form:option value="IIe">IIe</form:option>
