...
<script type="text/javascript">
 ...
 function loadTask(tabType) {
		$.ajax({
					type : "GET",
					url : "${rootUrl}duty/atmday/router/ajaxLoad.dox",
					dataType : "json",
					data : {
						tabType : tabType,
					},
 ...
 function change(tabType) {
		...
		if(tabType=='WKZX'){
			$.ajax({
				type : "post",
				url : "${rootUrl}duty/atmday/router/manage.do",
				dataType : "json",
				data : {
					tabType : tabType
				}
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}duty/atmday/router/manage.do"
									method="post">
									<!-- 保存所选TAB页 -->
									<form:hidden id="tabType" path="tabType" />
									<!-- 查询条件 -->
									<div id="tabs" style="padding-bottom: 23px">
										<ul>
											<sec:authorize
												...
												<c:if test="${atmType eq 'ROUTER'}">
													<li id="wkzx" style="position: relative;"><a
														id="queryButton" href="#tabs-1" onclick="change('WKZX');">
															雷达业务路由器(北京网控中心) </a></li>
												</c:if>
												<c:if test="${atmType eq 'ROUTER'}">
													<li id="kgj" style="position: relative;"><a
														id="queryButton" href="#tabs-1" onclick="change('KGJ');">
															雷达业务路由器(民航局空管局) </a></li>
												</c:if>
										...
										<div>
											<c:if test="${atmType eq 'ROUTER' }">
												...
												<div id="tabs-1"
													...
													<sec:authorize
														...
														<div class="boxbtn">
															<a href="${rootUrl}duty/atmday/router/add.do"
											...
											<c:if test="${atmType eq 'MGX'}">
												<div id="tabs-3"
													...
													<sec:authorize
														...
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/txjd8850add.do?tabType=txjd8850"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
												...
												<div id="tabs-4"
													style="padding-bottom: 0px; padding-left: 0px; margin: 0px">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['txjds_check_mgx_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/txjd8830add.do?tabType=txjd8830"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
												...
												<div id="tabs-5"
													style="padding-bottom: 0px; padding-left: 0px; margin: 0px">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['slhs_check_mgx_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/slh8850add.do?tabType=slh8850"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
												...
												<div id="tabs-6"
													style="padding-bottom: 0px; padding-left: 0px; margin: 0px">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['slh_check_mgx_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/slh8830add.do?tabType=slh8830"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
												...
												<div id="tabs-7"
													style="padding-bottom: 0px; padding-left: 0px; margin: 0px">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['mhj_check_mgx_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/mhj8850add.do?tabType=mhj8850"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
												...
												<div id="tabs-8"
													style="padding-bottom: 0px; padding-left: 0px; margin: 0px">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['kgj_check_mgx_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/kgj8850add.do?tabType=kgj8850"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
												...
												<div id="tabs-9"
													style="padding-bottom: 0px; padding-left: 0px; margin: 0px">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['cf_check_mgx_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/atmday/mgx/cf8830add.do?tabType=cf8830"
																class="my_add {boxwidth:1000,boxheight:700} btn"><img
																src="${rootUrl}images/btn/new.gif" />添加</a>
														</div>
														<div class="bclear"></div>
											...
											<div class="boxbtn">
												<div id="info1" class="info" style="height: 50px">
													...
													&nbsp;&nbsp; 审核人：
													<form:input path="auditor" size="15" maxlength="50"
														cssStyle="width:190px" />
													<div class="bclear"></div>
													巡检时间：
