...
public interface SlhDataStateService {
	 ...
	 * @throws
	 */
	SlhDataStateModel save(SlhDataStateModel Slhdatastate);
	 ...
	 * @throws
	 */
	SlhDataState findById(String id);
	 ...
	 * @throws
	 */
	SlhDataStateModel update(SlhDataState datastate,
	 ...
	 * @throws
	 */
	void delete(SlhDataState datastate, EnvironmentEquipCheck enviroment);
