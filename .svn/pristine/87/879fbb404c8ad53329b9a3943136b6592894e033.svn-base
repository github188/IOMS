 ...
 */
public enum SatelliteCheckContent {
	//日检手检
	TxjdDataState("通信基地TES网管数据库"),
	TxjdProState("通信基地TES网管进程"),
	TxjdWorkCon("通信基地TES网管工作站连通性"),
	TxjdTesDec("通信基地TES DecServer连通性"),
	TxjdSynState("通讯基地TES网管同步状态"),
	TxjdMainState("通信基地TES网管工作站主备状态"),
	...
	private SatelliteCheckContent(String value) {
		this.value = value;
	}
