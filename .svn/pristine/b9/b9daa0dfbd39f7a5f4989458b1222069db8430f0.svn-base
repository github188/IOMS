						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}news/browse/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn" >
										<div class="info">
											栏目：     
											<form:select path="columnEq" cssStyle="width:60px;margin-left:12px;">
											...
											<br />
											提交人：
											<form:input path="submitUserNameEq" size="10" maxlength="30" />
											
											<div style="float:right;width:100px;margin-right:400px;">
