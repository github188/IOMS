...
<tr>
	...
	<td><sec:authorize
			...
			ifAnyGranted="${jspAuthorities['sta_check_odustate_del']}">
			<a href="${rootUrl}duty/statelliteday/odustate/delete.do?id=${vo.id}"
			...
			<sec:authorize
				ifAnyGranted="${jspAuthorities['sat_check_odustate_update']}">
				<a
					href="${rootUrl}duty/statelliteday/odustate/update.do?id=${vo.id}"
