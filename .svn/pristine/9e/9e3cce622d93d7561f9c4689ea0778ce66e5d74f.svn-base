 ...
 */
@Repository("satTxjdOverseaHwDao")
public class SatTxjdOverseaHWDaoImpl extends MyBaseDao<SatTxjdOverseaHW> implements SatTxjdOverseaHWDao{
	...
	public Pagination queryPageByModel(SatelliteAutoModel queryModel) {
		...
		//封装数据查询语句
		StringBuilder hql = new StringBuilder(" from SatTxjdOverseaHW a where 1=1 ");
		//封装查询条件
