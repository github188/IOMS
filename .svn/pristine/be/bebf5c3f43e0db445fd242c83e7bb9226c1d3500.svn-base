...
<script src="${rootUrl }js/plugins/html/jquery.outerhtml.js"
	type="text/javascript"></script>
<script src="${rootUrl }js/activiti/transferNetWorkflow.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	function loadTask() {
		$.ajax({
					type : "GET",
					url : "${rootUrl}transfernet/ajaxLoad.dox",
					dataType : "json",
	...
	<div id="boxmain">
		...
		<div id="boxright">
			...
			<div id="main">
				...
				<div id="boxplace">
					<div class="place">
						<span class="bold">自动转报网节点入网</span>
					</div>
				</div>
				<!--place-->
				<div class="minfo">
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm" name="listForm"
									action="${rootUrl}transfernet/tasklist.do" method="post">
