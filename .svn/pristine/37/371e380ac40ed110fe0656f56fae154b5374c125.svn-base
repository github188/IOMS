...
<script type="text/javascript">
	...
	function loadTask(optType) {
		$.ajax({
				type : "GET",
				url : "${rootUrl}duty/dgdutyyear/ajaxLoad.dox",
				dataType : "json",
				data : {
					optType : optType,
				},
...
<body>
									...
									<div id="tabs" style="padding-bottom: 23px">
										...
										<div>
                                            ...
                                            <div id="tabs-1" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['dg_check_year_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/dgdutyyear/add.do"
	...
	<input id="item" value='dgdutyyear' style="display:none"></input>
</body>
</html>