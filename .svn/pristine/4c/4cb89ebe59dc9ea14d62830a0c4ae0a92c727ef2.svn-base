...
<table width="100%">
	<tr>
		...
		<th colspan="3">
			<form:select path="name" cssStyle="width:200px">
				<c:forEach items="${txjdUpsName}" var="vo">
	...
	<tr>
		<th width="15%" rowspan="16">巡检内容</th>
	...
	<tr>
		...
		<td colspan="2"><form:input path="zgvInputMeasure"/></td>
		<td colspan="2"><form:input path="zgvInputResult"/></td>
	</tr>
	<tr>
		<td colspan="2">输出端零地电压(V)</td>
		<td colspan="2"><form:input path="zgvOutputMeasure"/></td>
		<td colspan="2"><form:input path="zgvOutputResult"/></td>
	</tr>
	<tr>
		<td rowspan="2">零线电流测量(A)</td>
		<td>输入端：</td>
		<td colspan="2"><form:input path="zlcInputMeasure"/></td>
		<td colspan="2"><form:input path="zlcInputResult"/></td>
	</tr>
	<tr>
		<td>输出端：</td>
		<td colspan="2"><form:input path="zlcOutputMeasure"/></td>
	...
	<tr>
		<td><form:input path="number" value="33" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="34" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="35" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="36" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="37" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="38" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="39" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="40" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
		<tr>
		<td><form:input path="number" value="41" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="42" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="43" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="44" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="45" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="46" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="47" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="48" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="49" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="50" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="51" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="52" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="53" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="54" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="55" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="56" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="57" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="58" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="59" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="60" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
		<tr>
		<td><form:input path="number" value="61" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="62" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="63" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="64" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="65" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="66" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="67" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="68" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="69" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="70" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="71" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="72" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="73" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="74" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="75" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="76" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="77" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="78" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="79" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<tr>
		<td><form:input path="number" value="80" readonly="true" cssStyle="text-align:center"/></td>
		<td><form:input path="termialV"/></td>
		<td colspan="2"><form:input path="interR"/></td>
		<td colspan="2"><form:input path="remarks"/></td>
	</tr>
	<!-- 放电测试 -->
	<tr><th width="100%" colspan="6">放电测试</th></tr>
	<tr>
		<th colspan="2">放电开始时间:
		...
		<th colspan="2">放电持续时间(分钟):<form:input id="durationTime" path="durationTime" onFocus="subFn()"/></th>
	</tr>
	<tr>
		<th colspan="2">放电前总电压:<form:input path="preTotalV"/></th>
		<th colspan="2">放电终止总电压:<form:input path="endTotalV"/></th>
		<th colspan="2">电池充电电流:<form:input path="batChargingC"/></th>
	</tr>
	<tr>
		<th>放电时间(分钟)</th>
		<th>电池总电压</th>
	...
	<tr>
		<td><form:input path="dsTime"/></td>
		<td><form:input path="batTotalV"/></td>
		<td><form:input path="dsCurrent"/></td>
		<td><form:input path="singleMaxV"/></td>
		<td><form:input path="singleMinV"/></td>
