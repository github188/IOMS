...
/**
 * 通信基地光端机设备巡检controller
 * @author renyujuan
 * @time:2016年8月17日 下午1:44:46
 */
@Controller
@RequestMapping("/duty/psotduty/txjdotical/")
public class TxjdOticalController extends MyBaseController {
    ...
    public String addJump(@ModelAttribute("pageModel") PsOtAddForm psOtAddForm,
        ...
        //设备名称枚举类
        List<TxjdOticalName> txjdOticalName=Arrays.asList(TxjdOticalName.values());
        model.addAttribute("txjdOticalName", txjdOticalName);
        model.addAttribute("checkType", checkType);
        return "/duty/psotduty/txjdotical/add";
    ...
    public String view(@RequestParam("id") String id,
        ...
        return "/duty/psotduty/txjdotical/view";
    }
    ...
    public String updateJump(@ModelAttribute("pageModel") PsOtAddForm psOtAddForm,
        ...
        EnvironmentEquipCheck psOtCheck = envirEquipCheckService.findById(id);
        model.addAttribute("psOtCheck", psOtCheck);
        return "duty/psotduty/txjdotical/update";
