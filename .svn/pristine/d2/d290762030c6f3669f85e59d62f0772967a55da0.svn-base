...
<script type="text/javascript">
    ...
    function loadTask(optType) {
        $.ajax({
                    type : "GET",
                    url : "${rootUrl}duty/upsdutymonth/slhups/ajaxLoad.dox",
                    dataType : "json",
                    data : {
                        optType : optType
                    },
	...
	function change(optType) {
		...
		if(optType=='slhUpsCheck'){
			$.ajax({
				type : "GET",
				url : "${rootUrl}duty/upsdutymonth/slhups/ajaxEquip.dox",
				dataType : "json",
				data : {
					optType : optType
				},
...
<body>
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}duty/upsdutymonth/slhups/manage.do"
									method="post">
									<!-- 保存所选TAB页 -->
									...
									<div id="tabs" style="padding-bottom: 23px">
										<ul>
											<sec:authorize
												ifAnyGranted="${jspAuthorities['ups_check_month_tab']}">
										...
										<div>
                                            ...
                                            <div id="tabs-1" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['ups_check_month_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutymonth/slhups/add.do"
                                            ...
                                            <div id="tabs-2" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['kuups_check_month_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutymonth/kuups/add.do"
                                                            class="my_add {boxwidth:1000,boxheight:700} btn"><img
                                                            src="${rootUrl}images/btn/new.gif" />添加</a>
                                                    </div>
                                                    <div class="bclear"></div>
                                            ...
                                            <div id="tabs-3" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['txjdups_check_month_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutymonth/txjdups/add.do"
                                                            class="my_add {boxwidth:1000,boxheight:700} btn"><img
                                                            src="${rootUrl}images/btn/new.gif" />添加</a>
                                                    </div>
                                                    <div class="bclear"></div>
                                            ...
                                            <div id="tabs-4" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['zjups_check_month_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutymonth/zjups/add.do"
                                                            class="my_add {boxwidth:1000,boxheight:700} btn"><img
                                                            src="${rootUrl}images/btn/new.gif" />添加</a>
                                                    </div>
                                                    <div class="bclear"></div>
											...
											<div class="boxbtn">
												...
												<br /> <br />&nbsp&nbsp<a href="#none" class="sbtn"
	...
	<input id="item" value='column_upsdutymonth' style="display:none"></input>
</body>
</html>