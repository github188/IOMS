...
<body>
	<div class="window" style="min-height: 620px;min-width:500px">
		<dl class="title">
			<dd>数据管理--TES 业务--Excel导入</dd>
			<dt>
		...
		<div>
			<form:form name="myForm" method="post" enctype="multipart/form-data"
				...
				action="${rootUrl}basedata/tes/service/impexcel.do" id="myForm">
		...
		<c:if test="${not empty failedData}">
			...
			<div class="boxbtn">
				<a href="#" id="upRtn" name="upRtn" class="btn"
					onclick="javascript:window.location.href='${rootUrl }basedata/tes/service/impexcel.do'">返回</a>
			</div>
		</c:if>
		<br />
	</div>
