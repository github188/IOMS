 ...
 * 数据库接口实现类
 * @author 段衍林
 * @2016年11月16日 上午10:13:33
 */
@Repository("txjdRadarLinkDao")
public class TxjdRadarLinkDaoImpl  extends MyBaseDao<TxjdRadarLink> implements TxjdRadarLinkDao {

	@Override
	public Pagination queryPageByModel(EnvironmentCheckQueryModel queryModel) {
		
		//封装数据查询语句
		StringBuilder hql = new StringBuilder(" from TxjdRadarLink a where 1=1 ");
		//封装查询条件
