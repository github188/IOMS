	...
	<table id="dataTable"  border="0" cellspacing="0"
		...
		<thead>
            ...
            <tr>
                ...
                <th rowspan="2" colspan="2">交流电输入电压（V）</th>
                <th rowspan="2" colspan="2">直流电输出电压（V）</th>
                <th rowspan="2" colspan="2">蓄电池电压（V）</th>
                <th rowspan="2" colspan="2">蓄电池内阻</th>
                <c:if test="${checkType eq 'QUARTER' or checkType eq 'YEAR' }">
                    <th rowspan="2" colspan="2">电池连接</th>
                </c:if>
                <th rowspan="2" colspan="2">逆变器</th>
                <c:if test="${checkType eq 'QUARTER' or checkType eq 'YEAR' }">
                    <th rowspan="2" colspan="2">保险</th>
