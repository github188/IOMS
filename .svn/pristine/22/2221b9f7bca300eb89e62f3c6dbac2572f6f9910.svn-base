	...
	<table id="dataTable" border="0" cellspacing="0" cellpadding="2"
		...
		<thead>
			<tr>
				...
				<th width="20" rowspan="2" scope="col">巡检内容</th>
				...
				<th colspan="2" scope="col">1009</th>
			...
			<tr>
				...
				<th width="19" scope="col">机箱风扇运行情况</th>
