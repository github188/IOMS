 ...
 */
@Repository("TesCheckDao")
public class TesCheckDaoImpl extends MyBaseDao<TesCheck> implements TesCheckDao {
	@Override
	public Pagination queryPageByModel(EnvironmentCheckQueryModel queryModel) {

		StringBuilder hq = new StringBuilder(
				"select new cn.com.atnc.ioms.model.duty.statellite.mqy.TesCheckModel "
						+ "(a.recordGz , a.recordManual , a.recordBj , a.recordBf , "
						+ "a.recordGzBz , a.recordManualBz , a.recordBjBz , a.recordBfBz"
						+ " , a.id , a.checkid , e.checkDate , e.checkTime , e.operator ) "
						+ "from TesCheck a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
		...
		StringBuilder hql = new StringBuilder(
				" select count(a.id) from TesCheck a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id  ");
	...
	@Override
	public List<TesCheck> queryList(EnvironmentCheckQueryModel queryModel) {
		...
		return (List<TesCheck>) super.queryList(hql.toString());
	}
}
