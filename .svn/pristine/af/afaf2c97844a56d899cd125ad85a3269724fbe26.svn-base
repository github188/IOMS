...
<body style="overflow-x: hidden">
 <form:form modelAttribute="pageModel" id="addForm" name="addForm"
		action="${rootUrl }phonemng/contactsmng/add.do" method="post">
	<div class="window"
		...
		<div class="mtab">
			...
			<tr>
				...
				<th>联系电话</th>
				<td>
				   <form:input path="telNumber" id="telNumber" />
				</td>
			</tr>
			...
			<tr>
				...
				<textarea id="remark" name="remark" rows="10" cols="100" style="width:80%" text=""></textarea>
				</td>
