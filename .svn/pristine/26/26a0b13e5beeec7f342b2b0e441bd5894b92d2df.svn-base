					...
					<div class="bl">
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									<sec:authorize
										ifAnyGranted="${jspAuthorities['dept_add']}">
										<a href="${rootUrl }systemmng/deptinfomng/add.do"
											class="my_add {boxwidth:550,boxheight:320} btn"><img
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}systemmng/deptinfomng/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
											...
											名称：
											<form:input path="deptName" cssStyle="width:160px" />
