 ...
 */
@Service
public class PnniLnsCesmDaoImpl extends MyBaseDao<PnniLnsCesm> implements IPnniLnsCesmDao {
	...
	public Pagination queryPnniLnsCesmPageByModel(NetworkStatQueryModel queryModel) {
		...
		hql.append("from PnniLnsCesm where 1=1 ");
		...
		//System.out.println("hql:"+hql.toString()+" nodecode:"+queryModel.getNodeCode()+" portType:"+queryModel.getPortType());
