package cn.com.atnc.ioms.model.business.telegraph;
 ...
 *
 * @author WangLingbin
 * @date 2015年6月18日 上午10:22:46
 * @since 1.0.0
 */
public class TeleGraphQueryModel extends MyPaginModel {

	private String id;                            //申请记录主键
	private String engineer;					  //配置工程师（移交的工程师）
	...
	private TeleGraphApproveStatEnum approveStatus;		  //申请审批状态
	...
	private List<TeleGraphApproveStatEnum> statusList;      //审批状态查询条件
	...
	private List<TeleGraphApply> teleGraphApplys;		//转报地址
	private List<TeleGraphCircuit> teleGraphCircuits;   //转报电路
	...
	public TeleGraphApproveStatEnum getApproveStatus() {
		return approveStatus;
	}

	public void setApproveStatus(TeleGraphApproveStatEnum approveStatus) {
	...
	public List<TeleGraphApproveStatEnum> getStatusList() {
		return statusList;
	}

	public void setStatusList(List<TeleGraphApproveStatEnum> statusList) {
	...
	public List<TeleGraphApply> getTeleGraphApplys() {
		return teleGraphApplys;
	}

	public void setTeleGraphApplys(List<TeleGraphApply> teleGraphApplys) {
		this.teleGraphApplys = teleGraphApplys;
	}

	public List<TeleGraphCircuit> getTeleGraphCircuits() {
		return teleGraphCircuits;
	}

	public void setTeleGraphCircuits(List<TeleGraphCircuit> teleGraphCircuits) {
		this.teleGraphCircuits = teleGraphCircuits;
	}
