...
<body>
	<div class="window">
		...
		<div class="mtab">
			<form:form modelAttribute="pageModel" id="editForm" name="editForm" action="${rootUrl}duty/accduty/txjd/update.do" method="post">
				<input type="hidden" id="id" name="id" value="${accCheck.id }"/>
