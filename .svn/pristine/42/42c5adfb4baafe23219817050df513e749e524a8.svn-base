 ...
 */
@Repository("SlhEquStateDao")
public class SlhEquStateDaoImpl extends MyBaseDao<SlhEquState> implements
		SlhEquStateDao {
	...
	public Pagination queryPageByModel(EnvironmentCheckQueryModel queryModel) {
		...
		StringBuilder hq = new StringBuilder(
				"select new cn.com.atnc.ioms.model.duty.statellite.day.SlhEquStateModel "
						+ "(a.dpc38 , a.dpc58 , a.NCC62 , a.NCC63 , a.umodup , a.umoddown , "
						+ "a.id , a.checkid , e.checkDate , e.checkTime , e.operator ) "
						+ "from SlhEquState a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
		...
		StringBuilder hql = new StringBuilder(
				" select count(a.id) from SlhEquState a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
	...
	@Override
	public List<SlhEquState> queryList(EnvironmentCheckQueryModel queryModel) {
		...
		return (List<SlhEquState>) super.queryList(hql.toString());
	}
