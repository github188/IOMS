...
/**
 * ddn节点机设备巡检controller
 * @author renyujuan
 * @time:2016年8月17日 下午1:44:46
 */
@Controller
@RequestMapping("/duty/psotduty/ddn/")
public class DdnController extends MyBaseController {
    ...
    public String addJump(@ModelAttribute("pageModel") PsOtAddForm psOtAddForm,
        ...
        //设备名称枚举类
        List<DdnName> ddnName=Arrays.asList(DdnName.values());
        model.addAttribute("ddnName", ddnName);
        model.addAttribute("checkType", checkType);
        return "/duty/psotduty/ddn/add";
    ...
    public String updateJump(@ModelAttribute("pageModel") PsOtAddForm psOtAddForm,
        ...
        EnvironmentEquipCheck psOtCheck = envirEquipCheckService.findById(id);
        model.addAttribute("psOtCheck", psOtCheck);
        return "duty/psotduty/ddn/update";
