...
/**
 * 通信基地-TES-DecServer 连通性DAO接口实现类
 *
 * @author 段衍林
 * @2017年2月15日 上午9:53:03
 */
@Repository("TxjdDecConDao")
public class TxjdDecConDaoImpl extends MyBaseDao<TxjdDecCon> implements
		ITxjdDecConDao {
	...
	public Pagination queryPage(SatelliteBaseQueryModel queryModel) {
		...
		// 查询语句
		StringBuilder hql = new StringBuilder("from TxjdDecCon a where 1=1 ");
		// 查询条件
