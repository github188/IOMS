...
<script src="${rootUrl }js/plugins/html/jquery.outerhtml.js"
	type="text/javascript"></script>
<script src="${rootUrl }js/activiti/dataComNetworkWorkflow.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	function loadTask() {
		$.ajax({
					type : "GET",
					url : "${rootUrl}datacomnetwork/ajaxLoad.dox",
					dataType : "json",
	...
	<div id="boxmain">
		...
		<div id="boxright">
			...
			<div id="main">
				...
				<div id="boxplace">
					<div class="place">
						<span class="bold">数据通信网节点入网</span>
					</div>
				</div>
				<!--place-->
				<div class="minfo">
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm" name="listForm"
									action="${rootUrl}datacomnetwork/tasklist.do" method="post">
									<div id="tabs" style="padding-bottom:23px">
										<ul>
											<li id="take" style="position: relative;"><a id="queryButton" href="#tabs-1">申请处理</a></li>
										</ul>
										<div id="tabs-1">
