 ...
 * @version:1.0
 */
public interface FormalCircuitWorkflowService {
	 ...
	 * 
	 */
	public abstract ProcessInstance startWorkflow(FormalCircuit entity,
	 ...
	 * 
	 */
	public abstract List<FormalCircuit> findTodoTasks(String userId);
	 ...
	 * 
	 */
	public abstract List<FormalCircuit> findFinishedProcessInstaces(String userId);
