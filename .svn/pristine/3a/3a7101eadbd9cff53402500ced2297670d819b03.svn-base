					...
					<div class="bl">
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									<sec:authorize
										ifAnyGranted="${jspAuthorities['clientcompany_add']}">
										<a href="${rootUrl }systemmng/clientcompany/add.do"
											class="my_add{boxwidth:800,boxheight:240} btn"><img
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}systemmng/clientcompany/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
											...
											单位名称：
											<form:input id="company" path="company" cssStyle="width:160px" />
