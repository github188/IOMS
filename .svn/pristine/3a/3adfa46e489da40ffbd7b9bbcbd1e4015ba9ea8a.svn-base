...
public interface WhService {
	 ...
	 * @throws
	 */
	WhModel update(Wh Wh, EnvironmentEquipCheck enviroment, WhModel Whmodel);
	 ...
	 * @throws
	 */
	void delete(Wh wh, EnvironmentEquipCheck enviroment);
