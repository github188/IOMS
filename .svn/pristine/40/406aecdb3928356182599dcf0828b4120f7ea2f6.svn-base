 ...
 */
@Repository
public class PortMPSMATMDaoImpl extends MyBaseDao<PortMPSMATM> implements IPortMPSMATMDao {
	 ...
	 */
	@Override
	public Pagination queryMPSMATMPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PortMPSMATM where 1=1 ");
