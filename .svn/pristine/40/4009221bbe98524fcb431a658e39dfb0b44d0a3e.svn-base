...
<table width="100%">
	...
	<c:forEach items="${upsCheck.upsContentCheck }" var="ucc">
		<tr>
			<th width="15%" rowspan="16"><font color="red">(*)</font>巡检内容</th>
...
<%-- 		<tr><th width="100%" colspan="6"><font color="red">(*)</font>电池测量</th></tr>
		...
		<c:forEach items="${upsCheck.dischargeTest }" var="dt">
			<tr>
				...
				<td colspan="2">放电持续时间(分钟)：<form:input id="durationTime" path="durationTime" value="${dt.durationTime }" onFocus="subFn()"/></td>
			</tr>
			<tr>
