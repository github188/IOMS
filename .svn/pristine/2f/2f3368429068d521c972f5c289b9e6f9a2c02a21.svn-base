...
@Transactional
@Service
public class TeleGraphWorkflowServiceImpl implements
		TeleGraphWorkflowService {

	private static Logger logger = LoggerFactory.getLogger(TeleGraphWorkflowServiceImpl.class);
	@Autowired
	...
	public ProcessInstance startWorkflow(TeleGraph entity,
		...
		try {
			...
			processInstance = runtimeService.startProcessInstanceByKey(
					"TeleGraph", businessKey, variables);
	...
	public List<TeleGraph> findTodoTasks(String userId) {
		...
		TaskQuery todoQuery = taskService.createTaskQuery()
				.processDefinitionKey("TeleGraph").taskAssignee(userId)
		...
		TaskQuery claimQuery = taskService.createTaskQuery()
				.processDefinitionKey("TeleGraph").taskCandidateUser(userId)
				.active().orderByTaskCreateTime().asc().orderByTaskCreateTime()
				.desc();
	...
	public List<TeleGraph> findRunningProcessInstaces() {
		...
		ProcessInstanceQuery query = runtimeService
				.createProcessInstanceQuery()
				.processDefinitionKey("TeleGraph").active()
	...
	public List<TeleGraph> findFinishedProcessInstaces() {
		...
		HistoricProcessInstanceQuery query = historyService
				...
				.processDefinitionKey("TeleGraph").finished()
