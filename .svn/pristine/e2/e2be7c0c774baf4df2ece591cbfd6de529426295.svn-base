 ...
 */
@Entity
@Table(name="TB_OM_APPLY_DATACOMNETWORK_ATT")
public class DataComNetworkAttach extends MyStringUUIDEntity {
	...
	private NetWorkAttachTypeEnum attachType;
	...
	public NetWorkAttachTypeEnum getAttachType() {
		return attachType;
	}
	public void setAttachType(NetWorkAttachTypeEnum attachType) {
