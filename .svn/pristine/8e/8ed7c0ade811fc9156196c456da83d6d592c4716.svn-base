 ...
 *
 * @author 段衍林
 * @2016年11月11日 下午1:15:04
 */
@Repository("satTxjdKuDayDao")
public class SatTxjdKuDayDaoImpl extends MyBaseDao<SatTxjdKuDay> implements SatTxjdKuDayDao{
	...
	public Pagination queryPageByModel(SatelliteAutoModel queryModel) {
		...
		//封装数据查询语句
		StringBuilder hql = new StringBuilder(" from SatTxjdKuDay a where 1=1 ");
		//封装查询条件
