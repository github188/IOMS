...
public enum ApproveStatusEnum {
	...
	private ApproveStatusEnum(String value) {
		this.value = value;
	}
	...
	public static ApproveStatusEnum getApproveTypeEnumByOrdinal(int value) {
		for (ApproveStatusEnum type : ApproveStatusEnum.values()) {
	...
	public static ApproveStatusEnum getApproveTypeEnumByValue(String value) {
		for (ApproveStatusEnum type : ApproveStatusEnum.values()) {
