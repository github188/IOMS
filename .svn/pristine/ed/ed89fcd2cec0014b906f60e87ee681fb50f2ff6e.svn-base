...
public class TempCircuitKu extends StringUUIDEntity {
	...
	@Column(name = "A_NODE_NUMBER")
	public String getaNodeNumber() {
		return aNodeNumber;
	}

	public void setaNodeNumber(String aNodeNumber) {
		this.aNodeNumber = aNodeNumber;
	}
	...
	@Column(name = "B_NODE_NUMBER")
	public String getbNodeNumber() {
		return bNodeNumber;
	}

	public void setbNodeNumber(String bNodeNumber) {
		this.bNodeNumber = bNodeNumber;
	}
