 ...
 */
@Entity
@Table(name="TB_OM_APPLY_TRANSFERNET")
public class TransferNet extends MyStringUUIDEntity {
	...
	private TransferNetStatEnum approveStat;  //审批状态
	...
	public TransferNetStatEnum getApproveStat() {
		return approveStat;
	}
	public void setApproveStat(TransferNetStatEnum approveStat) {
