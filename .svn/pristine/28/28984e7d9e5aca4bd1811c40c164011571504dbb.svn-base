				...
				.click(
						function() {
							if ($(".pager").attr('totalcount') == '0') {
								...
								window.location.href = "${rootUrl}basedata/satellite/odu/expexcel.do";
							}
						});
	});
</script>
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									...
									<%-- <sec:authorize
										...
										<a href="${rootUrl }basedata/satellite/odu/expexcel.do" class="btn">
										<img
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}basedata/satellite/odu/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
											...
											ODU类型：
											<form:input path="oduTypeLike" size="10" maxlength="50" />
										</div>
