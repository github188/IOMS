...
public interface SpService {
	 ...
	 * @throws
	 */
	SpModel update(Sp sp, EnvironmentEquipCheck enviroment, SpModel spmodel);
	 ...
	 * @throws
	 */
	void delete(Sp sp, EnvironmentEquipCheck enviroment);
