...
public interface SlhNetConService {
	/**
	 * 保存
	 * 
	 * @author shijiyong
	 ...
	 * @throws
	 */
	SlhNetConModel save(SlhNetConModel slhnetconmodel);
	 ...
	 * @throws
	 */
	SlhNetConModel update(SlhNetCon slhnetcon,
	 ...
	 * @throws
	 */
	void delete(SlhNetCon slhnetcon, EnvironmentEquipCheck enviroment);
