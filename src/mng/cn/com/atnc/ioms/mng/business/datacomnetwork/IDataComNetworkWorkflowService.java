 ...
 * @since 1.0.0
 */
public interface IDataComNetworkWorkflowService {
	 ...
	 * @since 1.0.0
	 */
	public abstract ProcessInstance startWorkflow(DataComNetwork entity,
	 ...
	 * @since 1.0.0
	 */
	public abstract List<DataComNetwork> findTodoTasks(String userId);
	 ...
	 * @since 1.0.0
	 */
	public abstract List<DataComNetwork> findRunningProcessInstaces();
	 ...
	 * @since 1.0.0
	 */
	public abstract List<DataComNetwork> findRunningProcessInstaces(String userId);
	 ...
	 * @since 1.0.0
	 */
	public abstract List<DataComNetwork> findFinishedProcessInstaces();
	 ...
	 * @since 1.0.0
	 */
	public abstract List<DataComNetwork> findFinishedProcessInstaces(String userId);
