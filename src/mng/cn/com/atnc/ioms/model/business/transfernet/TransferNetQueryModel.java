package cn.com.atnc.ioms.model.business.transfernet;
...
/**
 * 自动转报网申请表基础信息QueryModel
 *
 * @author Wang Zhicheng
 * @date 2015年10月19日 下午2:59:12
 * @since 1.0.0
 */
public class TransferNetQueryModel extends MyPaginModel {
	...
	private List<TransferNetStatEnum> statusList; // 审批状态查询条件

	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	private Calendar fromApplyTime;
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	private Calendar toApplyTime;
	private String applyUserLike; // 申请人模糊查询
	private String applyComLike; // 申请单位模糊查询
	private String applyLinkmanLike; // 联系人模糊查询
	private TransferNetStatEnum approveStatus; //审批状态
	...
	public List<TransferNetStatEnum> getStatusList() {
		return statusList;
	}

	public void setStatusList(List<TransferNetStatEnum> statusList) {
		this.statusList = statusList;
	}

	public TransferNetStatEnum getApproveStatus() {
		return approveStatus;
	}

	public void setApproveStatus(TransferNetStatEnum approveStatus) {
