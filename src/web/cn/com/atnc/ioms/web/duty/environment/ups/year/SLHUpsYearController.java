 ...
 */
@Controller
@RequestMapping("/duty/upsdutyyear/slhups/")
public class SLHUpsYearController extends MyBaseController {
	...
	public String manageJump(@ModelAttribute("queryModel") EnvironmentCheckQueryModel queryModel, 
		...
		return "duty/upsdutyyear/slhups/manage";
	}
	...
	public String manage(@ModelAttribute("queryModel") EnvironmentCheckQueryModel queryModel, 
		...
		case "slhUpsCheck":
			...
			return "duty/upsdutyyear/slhups/queryResult";
		case "kuUpsCheck":
			model.addAttribute("pagn",upsCheckService.queryPageByModel(queryModel));
			return "duty/upsdutyyear/kuups/queryResult";
		case "txjdUpsCheck":
			model.addAttribute("pagn",upsCheckService.queryPageByModel(queryModel));
			return "duty/upsdutyyear/txjdups/queryResult";
		case "zjUpsCheck":
			model.addAttribute("pagn",upsCheckService.queryPageByModel(queryModel));
			return "duty/upsdutyyear/zjups/queryResult";
		default:
			model.addAttribute("pagn", upsCheckService.queryPageByModel(queryModel));
			return "duty/upsdutyyear/slhups/queryResult";
		}
	...
	public String addJump(@ModelAttribute("pageModel") UpsMonthAddForm upsMonthAddForm,
		...
		return "duty/upsdutyyear/slhups/add";
	}
	
	/**
	 * 添加ups设备季检记录
	 * @author renyujuan
	 * @date 2016年8月5日下午2:25:18
	 * @param upsMonthAddForm
	 * @param dsTime
	 * @param batTotalV
	 * @param dsCurrent
	...
	public String view(@RequestParam(value="id", required = true) String id,
		...
		return "duty/upsdutyyear/slhups/view";
	}
	
	/**
	 * 十里河ups设备年检记录更新
	 * @author renyujuan
	 * @date 2016年8月5日下午3:15:29
	 * @param upsMonthAddForm
	 * @param id
	 * @param request
	 * @param model
	...
	public String update(@ModelAttribute("pageModel") UpsMonthAddForm upsMonthAddForm,
		...
		model.addAttribute("contentCheckResult", contentCheckResult);
		model.addAttribute("upsCheck", upsCheck);
		return "duty/upsdutyyear/slhups/update";
	}
	
	/**
	 * 更新ups年检记录
	 * @author renyujuan
	 * @date 2016年8月5日下午3:10:09
	 * @param upsMonthAddForm
	 * @param dsTime
	 * @param batTotalV
	 * @param dsCurrent
