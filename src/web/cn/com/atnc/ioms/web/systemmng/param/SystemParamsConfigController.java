...
package cn.com.atnc.ioms.web.systemmng.param;
 ...
 */
@Controller
@RequestMapping("/systemmng/systemparam")
public class SystemParamsConfigController extends MyBaseController {
	@Autowired
	...
	public String doConfig(
		...
		try {
			...
			super.addSuccess(model, "配置系统参数成功！");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			super.addError(model, e.getMessage());
		} catch (ServiceException e) {
