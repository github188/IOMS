 ...
 */
@Entity
@Table(name = "TB_BD_ATM_PORT_MPSM_ATM")
public class PortMPSMATM extends MyStringUUIDEntity {
	...
	public String getIMAGRP_NUM() {
		return IMAGRP_NUM;
	}

	public void setIMAGRP_NUM(String iMAGRP_NUM) {
		IMAGRP_NUM = iMAGRP_NUM;
	}
