 ...
 */
@Repository
public class PortPXMDaoImpl extends MyBaseDao<PortPXM> implements IPortPXMDao {
	 ...
	 */
	@Override
	public Pagination queryPXMPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PortPXM where 1=1 ");
