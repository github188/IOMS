...
import cn.com.atnc.ioms.entity.operstat.atm.PortAXSME;
 ...
 * Atm端口详情Dao接口实现
 * @author：KuYonggang
 * @date：2014-6-23上午10:16:34
 * @version：1.0
 */
@Repository
public class PortAXSMEDaoImpl extends MyBaseDao<PortAXSME> implements IPortAXSMEDao {

	/**
	 * @see cn.com.atnc.ioms.dao.operstat.atm.IPortAXSMDao#queryAXSMEPageByModel(cn.com.atnc.ioms.model.operstat.atm.NetworkStatQueryModel)
	 * PortAXSMDaoImpl.java
	 */
	@Override
	public Pagination queryAXSMEPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PortAXSME where 1=1 ");
