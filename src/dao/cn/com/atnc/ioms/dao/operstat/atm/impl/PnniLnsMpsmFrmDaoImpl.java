...
import cn.com.atnc.ioms.entity.operstat.atm.PnniLnsMpsmFrm;
 ...
 */
@Service
public class PnniLnsMpsmFrmDaoImpl extends MyBaseDao<PnniLnsMpsmFrm> implements IPnniLnsMpsmFrmDao {
	 ...
	 */
	@Override
	public Pagination queryPnniLnsMpsmFrmPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PnniLnsMpsmFrm where 1=1 ");
