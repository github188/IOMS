...
import cn.com.atnc.ioms.entity.operstat.atm.PnniLnsAxsmT1E1;
 ...
 */
@Service
public class PnniLnsAxsmT1E1DaoImpl extends MyBaseDao<PnniLnsAxsmT1E1> implements IPnniLnsAxsmT1E1Dao {
	 ...
	 */
	@Override
	public Pagination queryPnniLnsAxsmT1E1PageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PnniLnsAxsmT1E1 where 1=1 ");
