...
import cn.com.atnc.ioms.entity.operstat.atm.PortFRSM;
 ...
 */
@Repository
public class PortFRSMDaoImpl extends MyBaseDao<PortFRSM> implements IPortFRSMDao {
	 ...
	 */
	@Override
	public Pagination queryFRSMPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PortFRSM where 1=1 ");
