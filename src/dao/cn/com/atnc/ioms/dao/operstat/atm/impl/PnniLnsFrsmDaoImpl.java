...
import cn.com.atnc.ioms.entity.operstat.atm.PnniLnsFrsm;
 ...
 */
@Service
public class PnniLnsFrsmDaoImpl extends MyBaseDao<PnniLnsFrsm> implements IPnniLnsFrsmDao {
	 ...
	 */
	@Override
	public Pagination queryPnniLnsFrsmPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PnniLnsFrsm where 1=1 ");
