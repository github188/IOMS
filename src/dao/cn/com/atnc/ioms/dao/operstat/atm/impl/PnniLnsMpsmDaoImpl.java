...
import cn.com.atnc.ioms.entity.operstat.atm.PnniLnsMpsm;
 ...
 */
@Service
public class PnniLnsMpsmDaoImpl extends MyBaseDao<PnniLnsMpsm> implements IPnniLnsMpsmDao {
	 ...
	 */
	@Override
	public Pagination queryPnniLnsMpsmPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PnniLnsMpsm where 1=1 ");
