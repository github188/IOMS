...
import cn.com.atnc.ioms.entity.operstat.atm.PortMPSMFR;
 ...
 */
@Repository
public class PortMPSMFRDaoImpl extends MyBaseDao<PortMPSMFR> implements IPortMPSMFRDao {
	 ...
	 */
	@Override
	public Pagination queryMPSMFRPageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PortMPSMFR where 1=1 ");
