...
import cn.com.atnc.ioms.entity.operstat.atm.PnniLnsAxsmOC3;
 ...
 */
@Service
public class PnniLnsAxsmOC3DaoImpl extends MyBaseDao<PnniLnsAxsmOC3> implements IPnniLnsAxsmOC3Dao {
	 ...
	 */
	@Override
	public Pagination queryPnniLnsAxsmOC3PageByModel(NetworkStatQueryModel queryModel) {
		StringBuffer hql = new StringBuffer();
		hql.append("from PnniLnsAxsmOC3 where 1=1 ");
