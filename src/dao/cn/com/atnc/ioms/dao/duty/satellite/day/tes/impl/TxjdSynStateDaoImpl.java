...
/**
 * 通信基地-TES-查看网管同步状态父级数据库接口实现类
 *
 * @author 段衍林
 * @2017年2月13日 下午3:59:43
 */
@Repository("TxjdSynStateDao")
public class TxjdSynStateDaoImpl extends MyBaseDao<TxjdSynState> implements
		ITxjdSynStateDao {
	...
	public Pagination queryPage(SatelliteBaseQueryModel queryModel) {
		...
		// 查询语句
		StringBuilder hql = new StringBuilder("from TxjdSynState a where 1=1 ");
		// 查询条件
