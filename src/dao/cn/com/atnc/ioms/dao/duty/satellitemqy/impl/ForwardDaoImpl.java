...
public class ForwardDaoImpl extends MyBaseDao<Forward> implements ForwardDao {
	@Override
	public Pagination queryPageByModel(EnvironmentCheckQueryModel queryModel) {

		StringBuilder hq = new StringBuilder(
				"select new cn.com.atnc.ioms.model.duty.statellite.mqy.ForwardModel "
						+ "(a.tesSum , a.tesUse , a.tesSur , a.tesDbm , a.tesDb , "
						+ "a.pesSum , a.pesUse , a.pesSur , a.pesDbm , a.pesDb , "
						+ "a.vsatSum , a.vsatUse , a.vsatSur , a.vsatDbm , a.vsatDb , "
						+ "a.comSum , a.comUse , a.comSur , a.comDbm , a.comDb"
						+ " , a.id , a.checkid , e.checkDate , e.checkTime , e.operator ) "
						+ "from Forward a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
		...
		StringBuilder hql = new StringBuilder(
				" select count(a.id) from Forward a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id  ");
	...
	@Override
	public List<Forward> queryList(EnvironmentCheckQueryModel queryModel) {
		...
		return (List<Forward>) super.queryList(hql.toString());
	}
}
