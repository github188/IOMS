 ...
 *
 * @author 段衍林
 * @2017年2月13日 下午12:58:04
 */
@Repository("DataStateDao")
public class DataStateDaoImpl extends MyBaseDao<DataState> implements
		IDataStateDao {
	...
	public Pagination queryPage(SatelliteBaseQueryModel queryModel) {
		...
		// 查询语句
		StringBuilder hql = new StringBuilder("from DataState a where 1=1 ");
		// 查询条件
