 ...
 */
@Repository("SlhNetConDao")
public class SlhNetConDaoImpl extends MyBaseDao<SlhNetCon> implements
		SlhNetConDao {
	...
	public Pagination queryPageByModel(EnvironmentCheckQueryModel queryModel) {
		...
		StringBuilder hq = new StringBuilder(
				"select new cn.com.atnc.ioms.model.duty.statellite.day.SlhNetConModel "
						+ "(a.con3 , a.con4 , a.con5 , a.con6 ,"
						+ " a.id , a.checkid , e.checkDate , e.checkTime , e.operator ) "
						+ "from SlhNetCon a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
		...
		StringBuilder hql = new StringBuilder(
				" select count(a.id) from SlhNetCon a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
	...
	@Override
	public List<SlhNetCon> queryList(EnvironmentCheckQueryModel queryModel) {
		...
		return (List<SlhNetCon>) super.queryList(hql.toString());
	}
