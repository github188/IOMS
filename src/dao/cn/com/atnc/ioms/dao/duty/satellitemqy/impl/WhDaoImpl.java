 ...
 */
@Repository("WhDao")
public class WhDaoImpl extends MyBaseDao<Wh> implements WhDao {

	@Override
	public Pagination queryPageByModel(EnvironmentCheckQueryModel queryModel) {

		StringBuilder hq = new StringBuilder(
				"select new cn.com.atnc.ioms.model.duty.statellite.mqy.WhModel "
						+ "(a.result , a.opinion"
						+ " , a.id , a.checkid , e.checkDate , e.checkTime , e.operator ) "
						+ "from Wh a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id ");
		...
		StringBuilder hql = new StringBuilder(
				" select count(a.id) from Wh a , EnvironmentEquipCheck e where 1=1 and a.checkid=e.id  ");
	...
	@Override
	public List<Wh> queryList(EnvironmentCheckQueryModel queryModel) {
		...
		return (List<Wh>) super.queryList(hql.toString());
	}
}
