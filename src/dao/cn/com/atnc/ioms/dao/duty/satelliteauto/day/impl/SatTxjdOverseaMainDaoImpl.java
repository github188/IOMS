 ...
 */
@Repository("satTxjdOverseaMainDao")
public class SatTxjdOverseaMainDaoImpl extends MyBaseDao<SatTxjdOverseaMain> implements SatTxjdOverseaMainDao{
	...
	public Pagination queryPageByModel(SatelliteAutoModel queryModel) {
		...
		//封装数据查询语句
		StringBuilder hql = new StringBuilder(" from SatTxjdOverseaMain a where 1=1 ");
		//封装查询条件
