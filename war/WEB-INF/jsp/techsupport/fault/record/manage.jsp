					...
					<div class="bl">
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									<sec:authorize ifAnyGranted="${jspAuthorities['DromeCode_Add']}">
										<a href="${rootUrl }techsupport/fault/record/add.do" class="my_add btn">添加</a>
									</sec:authorize>
								</div>
								<!-- 好像只是换行而已 -->
								<div class="bclear"></div>
								<!--管理按钮-->
								<form:form modelAttribute="queryModel" id="listForm" name="listForm" action="${rootUrl}techsupport/fault/record/manage.do"	method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info" style="height: 50px">
										故障类型：<form:select path="faultType" cssStyle="width:100px">
										   <form:option value="">请选择</form:option>
											...
											<form:input path="optClientLike" size="15" maxlength="50" />
											  申报时间：<form:input cssStyle="width:120px" path="fromConsultDate" cssClass="inputDate" readonly="true"
											...
											<form:option value="">请选择</form:option>
											<c:forEach items="${faultStatus }" var="vo">
												<form:option value="${vo.name() }">${vo.name }</form:option>												
											</c:forEach>
										   </form:select>
									...
									<div class="mtab">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" class="title">
											<tr>
												<td class="td1"><img src="${rootUrl}images/pl1.gif"	alt="" />故障申报记录</td>
