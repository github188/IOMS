...
<body>
	...
	<form:form modelAttribute="pageModel" id="solveForm" name="solveForm"
		action="${rootUrl }techsupport/fault/deal/solve.do" method="post">
		<form:hidden path="id" />
		...
		<div class="window">
			...
			<div
				...
				<table width="100%">
					<tr>
						<th width="23%" style="text-align: right;">处理：<span style="color: red">(*)</span></th>
					...
					<tr>
						...
						<td>
							<form:input cssStyle="width:400px" path="confirmTime"
