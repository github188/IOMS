...
<script type="text/javascript">
	...
	function loadTask(optType) {
		$.ajax({
				type : "GET",
				url : "${rootUrl}duty/dgdutyquarter/ajaxLoad.dox",
				dataType : "json",
				data : {
					optType : optType,
				},
...
<body>
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}duty/dgdutyquarter/manage.do"
									method="post">
									<!-- 保存所选TAB页 -->
									...
									<div id="tabs" style="padding-bottom: 23px">
										...
										<div>
                                            ...
                                            <div id="tabs-1" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['dg_check_quarter_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/dgdutyquarter/add.do"
	...
	<input id="item" value='dgdutyquarter' style="display:none"></input>
</body>
</html>