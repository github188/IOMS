...
<script type="text/javascript">
    ...
    function loadTask(optType) {
        $.ajax({
                    type : "GET",
                    url : "${rootUrl}duty/satellitetool/ajaxLoad.dox",
                    dataType : "json",
                    data : {
                    	optType : optType
                    },
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}duty/satellitetool/manage.do"
									method="post">
									<!-- 保存所选TAB页 -->
									...
									<div id="tabs" style="padding-bottom: 23px">
										<ul>
											<li id="tool" style="position: relative;"><a
												id="queryButton" href="#tabs-1" onclick="change('tool');">卫星工具库</a></li>
										</ul>
										<div>
											<div id="tabs-1"
												...
												<c:if test="${isflag eq 'yes' or currentUser.id eq 'admin' }">
													<sec:authorize
														ifAnyGranted="${jspAuthorities['satellite_tool_add']}">
														<div class="boxbtn">
															<a
																href="${rootUrl}duty/satellitetool/add.do?optType=tool"
