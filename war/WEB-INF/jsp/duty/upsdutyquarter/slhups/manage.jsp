...
<script type="text/javascript">
	...
	function loadTask(optType) {
		$.ajax({
					type : "GET",
					url : "${rootUrl}duty/upsdutyquarter/slhups/ajaxLoad.dox",
					dataType : "json",
					data : {
						optType : optType
					},
	...
	function change(optType) {
		...
		if(optType=='slhUpsCheck'){
			$.ajax({
				type : "GET",
				url : "${rootUrl}duty/upsdutyquarter/slhups/ajaxEquip.dox",
				dataType : "json",
				data : {
					optType : optType
				},
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}duty/upsdutyquarter/slhups/manage.do"
									method="post">
									<!-- 保存所选TAB页 -->
									...
									<div id="tabs" style="padding-bottom: 23px">
										...
										<div>
                                            ...
                                            <div id="tabs-1" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['slhups_check_quarter_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutyquarter/slhups/add.do"
                                            ...
                                            <div id="tabs-2" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['kuups_check_quarter_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutyquarter/kuups/add.do"
                                                            class="my_add {boxwidth:1000,boxheight:700} btn"><img
                                                            src="${rootUrl}images/btn/new.gif" />添加</a>
                                                    </div>
                                                    <div class="bclear"></div>
                                            ...
                                            <div id="tabs-3" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['txjdups_check_quarter_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutyquarter/txjdups/add.do"
                                                            class="my_add {boxwidth:1000,boxheight:700} btn"><img
                                                            src="${rootUrl}images/btn/new.gif" />添加</a>
                                                    </div>
                                                    <div class="bclear"></div>
                                            ...
                                            <div id="tabs-4" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['zjups_check_quarter_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/upsdutyquarter/zjups/add.do"
                                                            class="my_add {boxwidth:1000,boxheight:700} btn"><img
                                                            src="${rootUrl}images/btn/new.gif" />添加</a>
                                                    </div>
                                                    <div class="bclear"></div>
