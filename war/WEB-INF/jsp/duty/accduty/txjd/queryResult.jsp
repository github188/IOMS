...
<!-- 				<th rowspan="3">巡检时间</th>
                ...
                <c:if test="${checkType eq 'MONTH' }">
                    <th rowspan="3">巡检时间</th>
                    <th rowspan="3">设备名称</th> 
                    <th colspan="16">维护内容</th>
                    <th colspan="24">数据记录</th>
                    <th rowspan="3">操作人</th>
                    <th rowspan="3">操作</th> 
                </c:if>
                <c:if test="${checkType eq 'QUARTER' || checkType eq 'YEAR'}">
                    ...
                    <th colspan="22">维护内容</th>
                    <th colspan="30" rowspan="2">数据记录</th>
                    <th rowspan="4">操作人</th>
                    <th rowspan="4">操作</th> 
                </c:if>
<!-- 				<th rowspan="3">操作人</th>
            ...
            <c:if test="${checkType eq 'QUARTER' || checkType eq 'YEAR'}">
                <tr>
                    <th colspan="6">制冷系统</th>
                    <th colspan="4">室外冷凝设备</th>
                    <th colspan="4">加湿系统</th>
			...
			<tr>
                <c:if test="${checkType eq 'MONTH' }">
                    ...
                    <th colspan="2">过滤网</th>
                    <th colspan="2">凝结水管</th>
                    <th colspan="2">蒸发器翅片</th>
                    <th colspan="2">设备内部<br />外部表面</th>
                    <th colspan="2">设备周围环境</th>
                    <th colspan="2">上下排水管线路<br />水滤网</th>
                    <th colspan="2">加湿罐</th>
                </c:if>
                <c:if test="${checkType eq 'QUARTER' || checkType eq 'YEAR' }">
                    <!-- 制冷系统 -->
                    ...
                    <th colspan="2">所有继电器触点<br />电气元件</th>
                </c:if>
                    <th colspan="3">总电压</th>
                    <th colspan="3">总电流</th>
                    <th colspan="3">压缩机电流</th>
