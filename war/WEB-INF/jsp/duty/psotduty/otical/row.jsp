...
<tr>
	...
	<td>
		<sec:authorize ifAnyGranted="${jspAuthorities['psot_check_otical_view']}">
			<a class="my_edit {boxwidth:1000,boxheight:700}" 
			   href="${rootUrl}duty/psotduty/otical/view.do?id=${vo.id}">查看</a>
		</sec:authorize>
		...
		<sec:authorize ifAnyGranted="${jspAuthorities['psot_check_otical_update']}">
		<a href="${rootUrl}duty/psotduty/otical/update.do?id=${vo.id}"
