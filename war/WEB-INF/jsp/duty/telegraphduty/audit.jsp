...
<body>
	<div class="window">
		...
		<div class="mtab">
			<form:form id="auditForm" name="auditForm" action="${rootUrl}duty/telegraphduty/audit.do" method="post">
				<input type="hidden" id="id" name="id" value="${teleGraphSystem.id}"/>
