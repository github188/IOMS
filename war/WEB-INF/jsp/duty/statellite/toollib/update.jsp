...
tepicker/WdatePicker.js" type="text/javascript"></script>
	...
	$(function() {
		...
		$("#editForm").validate({
			...
			submitHandler : function(form) {
				if (confirm("您确定更新通信基地-TES-室内设备巡检记录吗？")) {
...
<body>
	<div class="window">
		...
		<div class="mtab">
			<form:form modelAttribute="pageModel" id="editForm" name="editForm" action="${rootUrl}duty/statellite/tesequ/update.do" method="post">
