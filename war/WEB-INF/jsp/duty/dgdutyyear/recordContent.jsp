...
<table width="100%">
	...
	<tr>
		...
		<td width="30%"><form:input  path="atsNumoneRemarks" /></td>
	</tr>
	<!--2号ATS -->
	<tr>
		...
		<td width="30%"><form:input  path="atsNumtwoRemarks" /></td>
	</tr>
	<!--各单位切换护头  -->
	<tr>
		...
		<td width="30%"><form:input  path="ushRemarks" /></td>
	</tr>
	<!--电缆检测  -->
	<tr>
		...
		<td width="30%"><form:input  path="cableTestRemarks" /></td>
	</tr>
	<!--润滑压力  -->
	<tr>
