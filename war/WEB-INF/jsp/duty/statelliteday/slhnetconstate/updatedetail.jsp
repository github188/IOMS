...
<table width="100%" border="0">
	...
	<tr>
		...
		<th scope="col"><form:input path="con3" value="${netcon.con3 }" /></th>
		<th rowspan="4" scope="col">0%</th>
		<th rowspan="4" scope="col">UCX窗口Ping四台工作站10个</th>
	</tr>
	<tr>
		<th scope="col">10.34.64.4(%)</th>
		<th scope="col"><form:input path="con4" value="${netcon.con4 }" /></th>
	</tr>
	<tr>
		<th scope="col">10.34.64.5(%)</th>
		<th scope="col"><form:input path="con5" value="${netcon.con5 }" /></th>
	</tr>
	<tr>
		<th scope="col">10.34.64.6(%)</th>
		<th scope="col"><form:input path="con6" value="${netcon.con6 }" /></th>
	</tr>
</table>
