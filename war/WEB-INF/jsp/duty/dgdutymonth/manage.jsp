...
<script type="text/javascript">
	...
	function loadTask(optType) {
		$.ajax({
				type : "GET",
				url : "${rootUrl}duty/dgdutymonth/ajaxLoad.dox",
				dataType : "json",
				data : {
					optType : optType,
				},
...
<body>
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}duty/dgdutymonth/manage.do"
									method="post">
									<!-- 保存所选TAB页 -->
									<form:hidden id="optType" path="optType" />
									<c:forEach items="${equipType }" var="et">
										<c:if test="${et eq 'DIESELGENERATOR' }">
									...
									<div id="tabs" style="padding-bottom: 23px">
										<ul>
											<sec:authorize
												ifAnyGranted="${jspAuthorities['dg_check_month_tab']}">
												<li id="dgCheck" style="position: relative;">
													<a id="queryButton" href="#tabs-1"
														onclick="change('dgCheck');">柴油发电机一/二号机 
													</a>
												</li>
											</sec:authorize>
										</ul>
										<div>
                                            ...
                                            <div id="tabs-1" style="padding-bottom:0px ;padding-left:0px; margin: 0px">
                                                <sec:authorize
                                                    ifAnyGranted="${jspAuthorities['dg_check_month_add']}">
                                                    <div class="boxbtn">
                                                        <a href="${rootUrl}duty/dgdutymonth/add.do"
	...
	<input id="item" value='dgdutymonth' style="display: none"></input>
</body>
</html>