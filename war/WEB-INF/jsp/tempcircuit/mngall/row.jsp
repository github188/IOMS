...
<tr>
	...
	<td width="10%"><fmt:formatDate value="${vo.planOpenTime.time}"
			type="date" pattern="yyyy-MM-dd" /></td>
	<td width="10%"><fmt:formatDate value="${vo.planEndTime.time}"
			type="date" pattern="yyyy-MM-dd" /></td>
	...
	<td class="tdbtn" width="10%"><a
		...
		class="my_add{boxwidth:850,boxheight:500}">日志</a> <c:if
			...
			test="${vo.circuitType=='KUDATA' || vo.circuitType=='KUBROADCAST'}">
