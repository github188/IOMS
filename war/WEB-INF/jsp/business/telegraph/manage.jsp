...
<script src="${rootUrl }js/plugins/html/jquery.outerhtml.js"
	type="text/javascript"></script>
<script src="${rootUrl }js/activiti/teleGraphWorkflow.js" type="text/javascript"></script>
<script type="text/javascript">
	...
	function loadTask() {
		$.ajax({
					type : "GET",
					url : "${rootUrl}telegraph/ajaxLoad.dox",
					dataType : "json",
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm" name="listForm"
									action="${rootUrl}telegraph/tasklist.do" method="post">
