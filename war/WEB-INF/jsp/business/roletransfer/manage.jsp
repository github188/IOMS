						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<sec:authorize
									...
									<div class="boxbtn">
										<a href="${rootUrl}roletransfer/add.do"
											class="my_add {boxwidth:600,boxheight:260} btn">添加</a>
									</div>
									<div class="bclear"></div>
								</sec:authorize>
								<!--管理按钮-->
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm" action="${rootUrl}roletransfer/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
