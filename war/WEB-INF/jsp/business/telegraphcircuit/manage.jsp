...
<script src="${rootUrl }js/plugins/html/jquery.outerhtml.js"
	type="text/javascript"></script>
<script src="${rootUrl }js/activiti/teleGraphCircuitWorkflow.js" type="text/javascript"></script>
<script type="text/javascript">
	...
	function loadTask() {
		$.ajax({
					type : "GET",
					url : "${rootUrl}telegraphcircuit/ajaxLoad.dox",
					dataType : "json",
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm" name="listForm"
									action="${rootUrl}telegraphcircuit/tasklist.do" method="post">
