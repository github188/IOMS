...
<script src="${rootUrl }js/plugins/html/jquery.outerhtml.js"
	type="text/javascript"></script>
<script src="${rootUrl }js/activiti/formalCircuitWorkflow.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	function loadTask() {
		$.ajax({
					type : "GET",
					url : "${rootUrl}formalcircuit/ajaxLoad.dox",
					dataType : "json",
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm" name="listForm"
									action="${rootUrl}formalcircuit/tasklist.do" method="post">
