...
<table id="dataTable" width="100%" border="0" cellspacing="0"
	...
	<thead>
		<tr>
			...
			<th data-options="15%">申请单位</th>
			<th data-options="10%">联系人</th>
			<th data-options="10%">联系电话</th>
			<th data-options="10%">电路类型</th>
			<th data-options="5%">申请类型</th>
			<th data-options="10%">申请时间</th>
			<!-- <th data-options="10%">审批状态</th> -->
			<th data-options="27%">审批进度</th>
			<th data-options="13%">操作</th>
		</tr>
	</thead>
	<tbody>
