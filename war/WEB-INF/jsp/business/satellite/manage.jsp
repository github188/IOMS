...
<script src="${rootUrl }js/plugins/html/jquery.outerhtml.js"
	type="text/javascript"></script>
<script src="${rootUrl }js/activiti/kuSatelliteWorkflow.js" type="text/javascript"></script>
<script type="text/javascript">
	...
	function loadTask() {
		$.ajax({
					type : "GET",
					url : "${rootUrl}kusatellite/ajaxLoad.dox",
					dataType : "json",
	...
	<div id="boxmain">
		...
		<div id="boxright">
			...
			<div id="main">
				...
				<div id="boxplace">
					<div class="place">
						<span class="bold">卫星通信网地球站入网处理</span>
					</div>
				</div>
				<!--place-->
				<div class="minfo">
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<form:form modelAttribute="queryModel" id="listForm" name="listForm"
									action="${rootUrl}kusatellite/tasklist.do" method="post">
