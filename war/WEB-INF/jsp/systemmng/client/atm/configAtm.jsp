...
/*     $("#del").click(function(){
    ...
    function changeEquip(checkbox) {
        ...
        if (checkbox.checked) {
			...
			+ "</div> " +  "</td>"
            $("#SelectEquipTable").append("<tr>" + id_td + count_td + name_td + code_td + model_td + bureau_td + del_td +"</tr>");
					...
					<div class="br">
						...
						<div id="lmsx">
							...
							<form:form modelAttribute="queryModel" id="listForm"
								name="listForm"
								action="${rootUrl}systemmng/client/queryAtm.dox" method="post">
								<!-- 查询条件 -->
								<div class="boxbtn" style="width: 90%; margin-left: 20px">
									<div class="info">
										...
										节点代码：
										<form:input path="code" size="10" maxlength="50"
											cssStyle="width:100px;margin-right:20px;" />
							...
							<div id="selectDiv"
								...
								<div class="mtab">
									<table border="0" cellspacing="0" cellpadding="0" class="title"
										...
										<tr>
											<td colspan="6" class="td1"><img src="${rootUrl}images/pl1.gif"
												alt="" />选中设备</td>
