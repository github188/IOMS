...
<tr id="${pnnoticelist.id }" tid="${pnnoticelist.id }">
	...
	<td class="tdbtn">
		<sec:authorize ifAnyGranted="${jspAuthorities['publicnoticeapp_apply']}">
			<a href="${rootUrl }publicnotice/pn/apply.do?id=${pnnoticelist.id}&&processInstanceId=${pnnoticelist.task.id}"
				class="my_edit {boxwidth:850,boxheight:330}">审批</a>
		</sec:authorize>
