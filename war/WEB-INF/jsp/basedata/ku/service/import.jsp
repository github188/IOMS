	...
	<div class="window" style="min-height: 620px;">
		...
		<div>
			<form:form name="myForm" method="post" enctype="multipart/form-data"
				...
				action="${rootUrl}basedata/ku/service/impexcel.do" id="myForm">
		...
		<c:if test="${not empty failedData}">
			<div class="mtab">
				<h1>导入失败记录</h1>
				<table style="width:96%;table-layout:fixed;" border="0" cellpadding="0" cellspacing="0">
			...
			<div class="boxbtn">
				<a href="#" id="upRtn" name="upRtn" class="btn"
					onclick="javascript:window.location.href='${rootUrl }basedata/ku/service/impexcel.do'">返回</a>
			</div>
		</c:if>
		<br />
	</div>
