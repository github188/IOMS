				...
				.click(
						function() {
							if ($(".pager").attr('totalcount') == '0') {
								...
								window.location.href = "${rootUrl }basedata/satellite/site/expexcel.do";
							}
						});
	});
</script>
					...
					<div class="bl">
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									<sec:authorize
										ifAnyGranted="${jspAuthorities['satellitesitemng_add']}">

										<a href="${rootUrl }basedata/satellite/site/add.do"
											class="my_add {boxwidth:500,boxheight:300} btn"><img
											src="${rootUrl}images/btn/new.gif" />添加</a>

									</sec:authorize>
									<sec:authorize
										ifAnyGranted="${jspAuthorities['satellitesitemng_impexcel']}">
										<a href="${rootUrl }basedata/satellite/site/impexcel.do"
											class="my_view {boxwidth:900,boxheight:650} btn"><img
											src="${rootUrl}images/btn/file.gif" />Excel导入 </a>
									</sec:authorize>
									<sec:authorize
										ifAnyGranted="${jspAuthorities['satellitesitemng_expexcel']}">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}basedata/satellite/site/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
