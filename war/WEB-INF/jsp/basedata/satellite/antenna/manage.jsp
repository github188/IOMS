				...
				.click(
						function() {
							if ($(".pager").attr('totalcount') == '0') {
								...
								window.location.href = "${rootUrl}basedata/satellite/antenna/expexcel.do";
							}
						});
	});
</script>
						...
						<div class="br">
							...
							<div id="lmsx">
								...
								<div class="boxbtn">
									...
									<sec:authorize
										ifAnyGranted="${jspAuthorities['antennamng_expexcel']}">
								...
								<form:form modelAttribute="queryModel" id="listForm"
									name="listForm"
									action="${rootUrl}basedata/satellite/antenna/manage.do"
									method="post">
									<!-- 查询条件 -->
									<div class="boxbtn">
										<div class="info">
