	...
	<div class="window" style="min-height: 620px;">
		...
		<div>
			<form:form name="myForm" method="post" enctype="multipart/form-data"
				...
				action="${rootUrl}basedata/tes/node/slot/impexcel.do" id="myForm">
				<c:if test="${empty failedData}">
					<table width="96%">
						<tr>
							<td align="center"><font color="red">*</font>TES槽位信息 文件路径:</td>
		...
		<c:if test="${not empty failedData}">
			...
			<div class="boxbtn">
				<a href="#" id="upRtn" name="upRtn" class="btn" 
					onclick="javascript:window.location.href='${rootUrl }basedata/tes/node/slot/impexcel.do'">返回</a>
			</div>
		</c:if>
		<br />
	</div>
