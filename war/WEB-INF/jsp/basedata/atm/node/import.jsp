	...
	<div class="window" style="min-height: 620px;">
		...
		<div>
			<form:form name="myForm" method="post" enctype="multipart/form-data"
				...
				action="${rootUrl}basedata/atm/node/impexcel.do" id="myForm">
		...
		<c:if test="${not empty failedData}">
			...
			<div class="boxbtn">
				<a href="#" id="upRtn" name="upRtn" class="btn"
					onclick="javascript:window.location.href='${rootUrl }basedata/atm/node/impexcel.do'">返回</a>
			</div>
		</c:if>
		<br />
	</div>
